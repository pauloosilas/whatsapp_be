...
const userSchema = mongoose.Schema({
    ...
    email:{
        type: String,
        require: [true, "Please provade tour email address"],
        unquie: [true, "This email address already exist"],
        lowercase: true,
  ...
  const UserModel = mongoose.UserModel || mongoose.model('UserModel', userSchema)
